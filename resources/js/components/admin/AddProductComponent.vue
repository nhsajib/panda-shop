...
<div class="container-fluid">
  <ul class="nav nav-tabs mt-1">
    <li id="tablink1"><a data-toggle="tab" href="#">Product</a></li>
    <li id="tablink2"><a data-toggle="tab" href="#">Image</a></li>
    <li id="tablink3"><a data-toggle="tab" href="#">Specification</a></li>
    <li id="tablink4"><a data-toggle="tab" href="#">Attribute</a></li>
  </ul>
            ...
            <div class="container mt-3">
                <div class="card bg-light">                    
                        ...
                        <div class="col-md-12">
                          <form @submit.prevent="">
                            ...
                            <div class="form-group">
                              ...
                              <vue-editor v-model="product.description" :editorToolbar="customToolbar" class="form-control"></vue-editor>
                            ...
                            <div class="form-group">
                              ...
                              <div>
                                <img :src="this.product.image" alt="" v-show="primaryImgPrev" class="img-thumbnail mt-2" width="180px">
                              </div>
                            </div>
                          </form>
                        </div>
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary float-right" @click="createproduct">&nbsp; Save &nbsp;</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container mt-3">
                <div class="card">                    
                    ...
                    <div class="card-footer border-top">
                      <button class="btn btn btn-outline-dark float-right" @click="onTab3">Next</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="container mt-3">
                <div class="card bg-light">                    
                    ...
                    <div class="card-footer">
                      <button class="btn btn btn-outline-dark float-right" @click="onTab4">&nbsp; Next &nbsp;</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="container mt-3">
                <div class="card bg-light">                    
                    ...
                    <div class="card-body">
                      <div class="row justify-content-center">
                        <form class="form-inline" @submit.prevent="setattroptname">
                          <div class="form-group mb-2">
                            <span class="bg-success text-light px-2 py-2">Aattribute Option Name</span>
                          </div>
                          <div class="form-group mx-sm-3 mb-2">
                            <label for="attr_opt_name" class="sr-only">Password</label>
                            <input type="text" v-model="attroptname.attr_opt_name" class="form-control" id="attr_opt_name" placeholder="Attribute Option Name" required :disabled="attrname == true">
                          </div>
                          <button type="submit" v-show="!attrSetSuccess" class="btn btn-primary mb-2">Set Name</button>
                          <div class="form-group mx-sm-1 mb-2">
                            <span v-show="attrSetSuccess"><i class="fas fa-check-circle fa-2x text-success"></i></span>
                          </div>
                        </form>
                      </div>
                    </div>
                    <div class="card-body" v-show="attrSetSuccess">
                      <div class="row justify-content-center">
                    ...
                    <div class="card-footer">
                      <button class="btn btn btn-outline-dark float-right" @click="onTab5">&nbsp; Next &nbsp;</button>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="card bg-light">
            ...
            <div class="card-body text-center">
              <div class="alert alert-success">
                <strong>Success!</strong> All product information has been successfully added.
              </div>
              <a href="/admin" class="btn btn-outline-secondary mr-1">Go Dashboard</a>
              <a href="/admin/add-product" class="btn btn-outline-secondary ml-1">Add another products</a>
            </div>
    ...
    export default {
        data(){
            return{
              ...
              attroptname: new Form({
                product_id: '',
                attr_opt_name: '',
              }),
              attrSetSuccess: false,
        ...
        methods:{
          ...
          // Product Attribute 
          removeattr(id){
            Notiflix.Block.Dots('div#attrdisplay', 'Please wait...');
            ...
            .then(res=>{
              ...
              Notiflix.Block.Remove('div#attrdisplay', 600);
            })
            .catch(e=>{
              console.log(e);
              Notiflix.Block.Remove('div#attrdisplay', 600);
          ...
          setattroptname(){
            this.attroptname.put('/api/admin/productattrname/'+this.attroptname.product_id)
            .then(res=>{
              this.attrSetSuccess = true;
              Notiflix.Notify.Success('Attribute Option Name Has Been Set Successfully.');
            })
            .catch(e=>{
              console.log(e);
            })
          ...
          // Product 
            createproduct(){
                ...
                Notiflix.Block.Dots('div#pcard-body', 'Please wait...');
                this.product.post('/api/admin/product')
                .then(res=>{
                  Notiflix.Notify.Success('Product Information Successfully Added');
                  Notiflix.Block.Remove('div#pcard-body', 600);
                  this.onTab2();
                  this.image.product_id = res.data.prodcut_id;
                  this.spec.product_id = res.data.prodcut_id;
                  this.attribute.product_id = res.data.prodcut_id;
                  this.attroptname.product_id = res.data.prodcut_id;
                })
                .catch(e=>{
                  Notiflix.Block.Remove('div#pcard-body', 600);
                  console.log(e)
        ...
        //Bootstrap Tabs
            ...
            onTab2(){
              //Active Next Tab
                $('#tab2').tab('show')
                $('#tablink2').addClass('on')

                //Deactive previous tab
                $('#tablink1').removeClass('on')
                $( "#tab1" ).removeClass( "show active" );
            },
            onTab3(){
              //Active Next Tab
                $('#tab3').tab('show')
                $('#tablink3').addClass('on')

                //Deactive previous tab
                $('#tablink2').removeClass('on')
            ...
            onTab4(){
              //Active Next Tab
                $('#tab4').tab('show')
                $('#tablink4').addClass('on')

                //Deactive previous tab
                $('#tablink3').removeClass('on')
